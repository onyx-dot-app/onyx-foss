...
**[Onyx](https://www.onyx.app/?utm_source=foss_repo&utm_medium=github&utm_campaign=readme)** is a feature-rich, self-hostable Chat UI that works with any LLM. It is easy to deploy and can run in a completely airgapped environment.
...
To learn more about the features, check out our [documentation](https://docs.onyx.app/welcome?utm_source=foss_repo&utm_medium=github&utm_campaign=readme)!
...
See guides below:
- [Docker](https://docs.onyx.app/deployment/local/docker?utm_source=foss_repo&utm_medium=github&utm_campaign=readme) or [Quickstart](https://docs.onyx.app/deployment/getting_started/quickstart?utm_source=foss_repo&utm_medium=github&utm_campaign=readme) (best for most users)
- [Kubernetes](https://docs.onyx.app/deployment/local/kubernetes?utm_source=foss_repo&utm_medium=github&utm_campaign=readme) (best for large teams)
- [Terraform](https://docs.onyx.app/deployment/local/terraform?utm_source=foss_repo&utm_medium=github&utm_campaign=readme) (best for teams already using Terraform)
- Cloud specific guides (best if specifically using [AWS EKS](https://docs.onyx.app/deployment/cloud/aws/eks?utm_source=foss_repo&utm_medium=github&utm_campaign=readme), [Azure VMs](https://docs.onyx.app/deployment/cloud/azure?utm_source=foss_repo&utm_medium=github&utm_campaign=readme), etc.)

> [!TIP]  
> **To try Onyx for free without deploying, check out [Onyx Cloud](https://cloud.onyx.app/signup?utm_source=foss_repo&utm_medium=github&utm_campaign=readme)**.
